...
from django_root import wine_tour
from django_root.wines.models import Wine, WineProducer
try:
    set
except NameError:
    ...
    def wrap_view(self, view):
        ...
        def wrapper(request, *args, **kwargs):
            try:
                ...
                return http.HttpBadRequest(content='Malformed JSON: %s' % e.args[0], status=400)
            except Exception, e:
...
class ModelResource(Resource):
    ...
    def obj_create(self, bundle, request=None, **kwargs):
        ...
        self.extract_bundle_info(bundle)
        self.sync_rdf_db(self.extract_bundle_info(bundle))
	return bundle
	...
	obj = kwargs.pop('_obj', None)
        ...
        self.sync_rdf_db(self.mimic_bundle_info(kwargs['pk']), delete=True)
	obj.delete()
