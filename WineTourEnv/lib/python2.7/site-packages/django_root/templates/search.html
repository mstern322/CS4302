...
<div class="container-fluid"> 
	...
	<div class="span9">
		...
		<input class="btn btn-success" id="submit_button" value="Find My Wine" />
	    </form>
	    </div>

	</div>

    <div class="span6 pull-right" style="position: absolute; top: 150px; right: 150px;">
	<div id="map_canvas" style="width: 450px; height: 300px"></div>
	<div id="directionsPanel" style="width: 475px;"></div>
    </div>
...
<script type="text/javascript">
   ...
   $(".add").click(function() {
	$("form > p:first-child").clone(true).insertBefore("form > p:first-child");
	$("form > p:first-child").children(".input-text").val("");
	return false;
    });
