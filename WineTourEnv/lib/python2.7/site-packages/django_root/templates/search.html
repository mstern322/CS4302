...
<script type="text/javascript">
	...
	function renderDirections(){
	    ...
	    $('#snippet_panel').html(snippets[currentRoute]);
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
		<div class="span9" id="wines">
			...
			<h4 class="pull-left">Origin Address&nbsp;&nbsp;</h4>
			<input class="pull-left" type="text" id="origin_address" style="width:40%;"/>
			<br/>
			<br/>
			<div style="position:relative;left:5%;">
			<span class="pull-left">Min Wineries&nbsp;&nbsp;</span>
			<select class= "pull-left" id="min_wineries" style="width:10%;">
			...
			<span class="pull-left">Max Wineries&nbsp;&nbsp;</span>
			<select class="pull-left" id="max_wineries" style="width:10%;">
			    <option value="1">1</option>
			    <option value="2">2</option>
			    <option value="3">3</option>
			    <option value="4">4</option>
		...
		<div class="span6 pull-right" style="position: absolute; top: 100px; right: 50px;">
			...
			<div id="snippet_panel" style="width: 200px;"></div>
...
<script type="text/javascript">
	...
	$("#submit_button").click(function(event) {
		event.preventDefault();
		var query = "?origin_address=" + $("#origin_address").val() + "&";
		if (!($("#min_wineries").val() && $("#max_wineries").val())){
		    alert('Please input minimum and maximum number of wineries');
		    event.stopImmediatePropagation();
		}
		query += "min=" + $("#min_wineries").val() + "&max=" + $("#max_wineries").val() + "&";
